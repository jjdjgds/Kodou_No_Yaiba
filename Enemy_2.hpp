...
private:
	...
	HashTable<AnimState_Enemy2, AnimDesc_Enemy2> m_anims{	// アニメーションの説明
		{ AnimState_Enemy2::Idle, {0, 0, 6, 0.12, true } },
		{ AnimState_Enemy2::Run,  { 1, 0, 8, 0.07, true } },
		{ AnimState_Enemy2::Hurt,  { 5, 0, 4, 0.15, false } },
		{ AnimState_Enemy2::Attack,  { 4,0, 9, 0.08, false } },
