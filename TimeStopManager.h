...
private:
	// 各タイプ別の時間スケール
	static inline double s_playerScale = 0.2;   // プレイヤー
	static inline double s_friendScale = 0.2;   // 味方（徐々に遅く）
	static inline double s_enemyScale  = 0.2;   // 敵（ほぼ停止）
	static inline double s_effectScale = 0.2;   // エフェクト（完全停止）
